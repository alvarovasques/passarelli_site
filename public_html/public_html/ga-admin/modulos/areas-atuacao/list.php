 ...
 */
 ...
 /**
  * Controle das informações de listagem de areas-atuacao
  */
	include (includeFile("list_controller"));

// mensagem de busca
	$search_txt = "Digite titulo para buscar";
?>
...
?>
			<tr class="item-<?php echo($i%2);?>">
				...
				<td class="last">
				<a href="<?php echo sprintf('?modulo=%s&amp;acao=%s&amp;id=%s&amp;pagina=%d', $the_module, ($item[2]?'Deactivate':'Activate'), $item[0], $the_page); ?>" title="<?php echo $item[2]?'Desativar':'Ativar'; ?> ítem">
					<img src="includes/images/icons/<?php echo $item[2]?'accept':'deny'; ?>.png" alt="<?php echo $item[2]?'Desativar':'Ativar'; ?>" title="<?php echo $item[2]?'Desativar':'Ativar'; ?> este ítem" /></a>
					<a href="<?php echo "?modulo={$the_module}&amp;acao=Edit&amp;id={$item[0]}"; ?>" title="Editar">
...
/* Path: ga-admin/modulos/areas-atuacao/list.php */