<?php
/**
 *	areas-atuacao::edit_controller.php
 *
...
// Campos que devem ser preenchidos, validação no servidor (apenas vazio)
	$required = "titulo,resumo,texto,ativo,ordem,";
...
// recupera e salva dados do POST (Edit, Add)
	if (isset($_POST["input"]))
	{
		...
		else
		{
			...
			if (!$rs  = _query($sql))
			{
				add_debug_msg( _sqlError(), sprintf("areas-atuacao/edit_controller.php[%s]", $the_action) );
...
/* Path: ga-admin/modulos/areas-atuacao/edit_controller.php */