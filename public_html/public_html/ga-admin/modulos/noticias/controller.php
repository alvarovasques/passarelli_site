 ...
 *</ol>
 *
 * @version   1.010, Created: 19/06/2013
...
// seta os labels dentro do modulo
	$the_module_labels = array(
		"new_txt"	=> "Nova Notícia",
		"new_alt"	=> "Adicionar nova notícia",
		"lst_txt"	=> "Listagem de notícias",
		"lst_alt"	=> "Voltar para Listagem",
		"edt_txt"	=> "Editar Notícia"
	);
...
/* Path: ga-admin/modulos/noticias/controller.php */