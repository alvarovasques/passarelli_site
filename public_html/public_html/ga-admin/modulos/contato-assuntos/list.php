<?php
/**
 *	contato-assuntos::list.php
 *
 * Arquivo de exibição de todos os itens cadastrados no módulo
 *
 * @version   1.101, Created: 26/06/2013
 ...
 */
 ...
 /**
  * Controle das informações de listagem de contato-assuntos
  */
	include (includeFile("list_controller"));

// mensagem de busca
	$search_txt = "Digite Título ou E-Mail para buscar";
?>
...
?>
		<tr class="item-<?php echo($i%2);?>">
			...
			<td>
				<a href="<?php echo "?modulo={$the_module}&amp;acao=Edit&amp;id={$item[0]}"; ?>" title="Editar">
					<?php echo htmlspecialchars($item[2]); ?></a>
			</td>
			<td class="last">
				<a href="<?php echo sprintf('?modulo=%s&amp;acao=%s&amp;id=%s&amp;pagina=%d', $the_module, ($item[3]?'Deactivate':'Activate'), $item[0], $the_page); ?>" title="<?php echo $item[3]?'Desativar':'Ativar'; ?> ítem">
					<img src="includes/images/icons/<?php echo $item[3]?'accept':'deny'; ?>.png" alt="<?php echo $item[3]?'Desativar':'Ativar'; ?>" title="<?php echo $item[3]?'Desativar':'Ativar'; ?> este ítem" /></a>
				<a href="<?php echo "?modulo={$the_module}&amp;acao=Edit&amp;id={$item[0]}"; ?>" title="Editar">
...
/* Path: ga-admin/modulos/contato-assuntos/list.php */