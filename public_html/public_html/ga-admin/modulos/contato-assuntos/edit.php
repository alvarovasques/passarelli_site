 ...
 *</ol>
 *
 * @version   2.000, Created: 26/06/2013
...
// <![CDATA[
	...
	jQuery(document).ready(function($){
		_valid = $('#contato-assuntos_form').validate({
			rules:{
...
<!--/* contato-assuntos/edit.php */-->
<form action="" method="post" id="contato-assuntos_form">
...
/* Path:  ga-admin/modulos/contato-assuntos/edit.php */