...
// ########## REMOCAO DE UM ITEM ##########
	if (isset($_GET["id"]) && $the_action == "Remove")
	{
		...
		if (!$rs  = _query($sql))
			add_debug_msg( _sqlError(), "artigos/list_controller.php" );
...
/* Path: ga-admin/modulos/artigos/list_controller.php */