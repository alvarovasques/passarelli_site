 ...
 *
 * @version   1.002, Created: 25/06/2013
...
// recupera e salva dados do POST (Edit, Add)
	if (isset($_POST["input"]))
	{
		...
		else
		{
			...
			if (!$rs  = _query($sql))
			{
				add_debug_msg( _sqlError(), sprintf("artigos/edit_controller.php[%s]", $the_action) );
...
/* Path: ga-admin/modulos/artigos/edit_controller.php */