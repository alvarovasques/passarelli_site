 ...
 *</ol>
 *
 * @version   1.010, Created: 25/06/2013
...
// seta os labels dentro do modulo
	$the_module_labels = array(
		"new_txt"	=> "Novo Advogado",
		"new_alt"	=> "Adicionar novo advogado",
		"lst_txt"	=> "Listagem de advogados",
		"lst_alt"	=> "Voltar para Listagem",
		"edt_txt"	=> "Editar Advogado"
	);
...
/* Path: ga-admin/modulos/advogados/controller.php */