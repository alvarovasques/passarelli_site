...
// recupera e salva dados do POST (Edit, Add)
	if (isset($_POST["input"]))
	{
		...
		else
		{
			...
			if (!$rs  = _query($sql))
			{
				add_debug_msg( _sqlError(), sprintf("advogados/edit_controller.php[%s]", $the_action) );
...
// #################### MIDIAS CONFIG ####################
 ...
 // mensagem das midias e possíveis labels
	$midia_msg = "Resolução sugerida 190x190 pixels";
...
/* Path: ga-admin/modulos/advogados/edit_controller.php */